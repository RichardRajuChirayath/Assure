...
export default function BackgroundParticles() {
    ...
    return (
        <div className="fixed inset-0 -z-10 bg-[#02020a] overflow-hidden">
            ...
            <div
                ...
                style={{
                    backgroundImage: `linear-gradient(to right, #7c69ef 1px, transparent 1px), linear-gradient(to bottom, #7c69ef 1px, transparent 1px)`,
